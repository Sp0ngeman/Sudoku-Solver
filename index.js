document.addEventListener('DOMContentLoaded', function () {
    ...
    // Move the refreshButton declaration and event listener outside of the DOMContentLoaded event handler
const refreshButton = document.getElementById("refresh-btn");
refreshButton.addEventListener('click', function () {
    location.reload(); // Reload the page to refresh the Sudoku
});
